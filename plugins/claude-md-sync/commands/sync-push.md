...
- **Force overwrite**: Run `cd "$CLAUDE_PLUGIN_ROOT" && cp ~/.claude/CLAUDE.md CLAUDE.md && git add CLAUDE.md && git commit -m "chore: force-update CLAUDE.md" && git push --force-with-lease`
